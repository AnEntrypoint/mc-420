...
KEYSBEND = hslider("fx/keys/bend", 0.0, -24.0, 24.0, 0.001);
...
with {
    ...
    harmonyBus     = harmonize(dry, loopSum, freeXpose, FORMANT, EXTFREQDET, KEYSBEND, s0,g0, s1,g1, s2,g2, s3,g3, s4,g4, s5,g5);
    dryWet         = harmonyBus : _,!;
