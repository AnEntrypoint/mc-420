...
declare description "Mic-excited modal resonator instrument, packaged as the standalone resonode.lv2 bundle. Four voices, twenty coupled modes per voice, convex-blended string/bell/plate/membrane/bar partial-ratio tables, constant-Q mode bandwidth, and nearest-neighbour mode coupling bounded below unity loop gain by peak-gain normalisation.";
