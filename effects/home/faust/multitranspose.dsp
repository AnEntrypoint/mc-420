...
with {
    ...
    rawDetNote = ba.hz2midikey(max(minTrackHz, freqDet));
    hasRealReading = freqDet > minTrackHz;
    lastConvergedNoteStep(prev) = ba.if(inLockWarmup | (hasRealReading == 0), prev, rawDetNote);
